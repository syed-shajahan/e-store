...
const Details: React.FC = () => {
  ...
  return (
    <div className="p-6">
      {detailData ? (
        <div className="bg-white  overflow-hidden max-w-[1200px] lg:flex block mx-auto">


          <div
            className="relative mb-3 block overflow-hidden w-full z-10 pt-[55%]"
          >
            <img
          ...
          <div className="p-6">
            ...
            <p className="text-[40px] font-bold mb-6 select-none">${detailData.price}</p>

            <div className="flex items-center gap-3 mb-3">
              <FaCircleMinus size={30} className="cursor-pointer hover:scale-[0.90px]" onClick={() => handleDecreaseQuantity(detailData.id)} />
              <span className="text-[30px] text-[#000] select-none">{addCartList.find((cart) => cart.id === detailData.id) ? detailData.qty : qty}</span>
